...
!-----------------------------------------------------------------------
   ...
   integer, parameter :: wvlng  = WVLNGTH_LRES             ! number of radiance points DRF
   integer, parameter :: wvlng_hres  = WVLNGTH_HRES        ! number of radiance points DRF
   integer, parameter :: aertau_species = AERTAU_SPECIES   ! number of aerosol species from radcswmx.F90 DRF
   integer, parameter :: num_bands = NUM_BANDS             ! number of flux bands to report DRF
