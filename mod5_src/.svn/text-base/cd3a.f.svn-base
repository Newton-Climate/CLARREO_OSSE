      SUBROUTINE CD3A(ANGLEM,IDAY,ISOURC,FILE_SCRATCH,TP5_FLAG,         &
...
!       LENGTH_FNAME   LENGTH OF FILE_SCRATCH (DRF MODIFICATION)
      LOGICAL LOPEN
      INTEGER LENGTH_FNAME,LENSTR
...
!         CARD 3A1:
          ...
          ELSE
             READ(TP5_FILE(TP5_LINENUMBER),'(4I5)')IPARM,IPH,IDAY,ISOURC
...
!             FIRST ISAACS SOLAR CALCULATION
              ...
              LENGTH_FNAME=LENSTR(FILE_SCRATCH)
              CALL OPNFL(ISCRCH,0,FILE_SCRATCH(1:LENGTH_FNAME),         &
     &                   'SCRATCH','UNFORMATTED','CD3A')
...
!         SAVE SOLAR PARAMETERS FOR COMPARING LATER.
     ...
     &      PRM1SV,PRM2SV,SLATSV,SLONSV,GMTSV,GSV,ANGMSV)
      ...
      ELSEIF(IPH.EQ.1)THEN
          CALL CD3B3C(TP5_FLAG,TP5_FILE,TP5_LINENUMBER)
      ENDIF
      IF(IRPT.EQ.3)THEN
