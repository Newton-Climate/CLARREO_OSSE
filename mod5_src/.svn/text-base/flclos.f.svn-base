...
!DRF      DATA SVSTAT/'KEEP'/
      DATA SVSTAT/'DELETE'/  !DRF MODIFICATION
      DATA DATASV/'DELETE'/
!DB   DATA DATASV/'KEEP'/
...
!DRF      INQUIRE(IRD,OPENED=LOPEN)
!DRF      IF(LOPEN)CLOSE(IRD,STATUS='DELETE')
      !IF(NOPRNT.EQ.3)THEN
...
!DRF          IF(LOPEN)CLOSE(IPR,STATUS='KEEP')
      !ENDIF
      INQUIRE(IPU,OPENED=LOPEN)
!DRF      IF(LOPEN)CLOSE(IPU,STATUS='KEEP')
      IF(LOPEN)CLOSE(IPU,STATUS='DELETE')
...
!DRF      IF(LOPEN)CLOSE(IPLOT,STATUS='KEEP')
...
!DRF      IF(LOPEN)CLOSE(IPTSCN,STATUS='KEEP')
...
!DRF      IF(LOPEN)CLOSE(IALB,STATUS='KEEP')
      IF(LOPEN)CLOSE(IALB,STATUS=SVSTAT)
