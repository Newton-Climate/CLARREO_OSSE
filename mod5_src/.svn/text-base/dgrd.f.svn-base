     ...
     &                WVLNGTH_LRES,RADIANCE_LRES,NUM_LRES)
...
!     OUTPUT ARGUMENTS:
!     WVLNGTH_LRES   CONVOLVED WAVELENGTH GRID
!     RADIANCE_LRES  CONVOLVED RADIANCE VALUES
!     NUM_LRES       SIZE OF WVLNGTH_LRES,RADIANCE_LRES
!     LNFLRT         SIZE OF FLRT (FOR DEBUGGING)
!     FLRT           FILENAME (FOR DEBUGGING)
      INTEGER NUM_LRES
...
!!!BEGIN DRF MODIFICATION
              IF (IDDGRD.LE.NUM_LRES) THEN
                WVLNGTH_LRES(IDDGRD) = WDGRD(IDDGRD)
                RADIANCE_LRES(IDDGRD) = SPCDAT(IDDGRD,KCOL)
              ENDIF
!!!END DRF MODIFICATION
          ENDDO
          IF(IEMSCT.EQ.3)THEN
