...
!!!DRF MODIFICATION
          INDEX1=FLOOR(1+(VOUT-V1)/DV)  
          IF (INDEX1.LE.NUM_LRES) THEN
          SOLAR_FLUX(FLOOR(1+(VOUT-V1)/DV)) =                           &
     &               DNDRCT(MLFLX,JFLUX)+CONWT*DNDRCT(MLFLX,-1)
          DIFFUSE_FLUX(FLOOR(1+(VOUT-V1)/DV)) =                         &
     &               UPDIFF(MLFLX,JFLUX)+CONWT*UPDIFF(MLFLX,-1)        
          ENDIF
!!!DRF MODIFICATION
...
!!!DRF MODIFICATION
              IF (IK.LE.NUM_LEVS .AND. INDEX1.LE.NUM_LRES) THEN    
