...
!                1-6     1-6    DEFAULT TO SPECIFIED MODEL ATMOSPHERE
     ...
     &              PPROF(K),TPROF(K),WMOL(1),WMOL(2),WMOL(3),JCHAR
                  ELSE
                  READ(TP5_FILE(TP5_LINENUMBER),'(6F10.0,A17)')ZM(K),   &
     &              PPROF(K),TPROF(K),WMOL(1),WMOL(2),WMOL(3),JCHAR   
     ...
     &              PPROF(K),TPROF(K),WMOL(1),WMOL(2),WMOL(3),JCHAR
              ...
              IF(IRD1.EQ.1)THEN
                  ...
                  ELSE
                     ...
                     ELSE
                      READ(TP5_FILE(TP5_LINENUMBER),'((8F10.0))')       &
     &                    WMOL(4),WMOL(5),WMOL(6),WMOL(7),WMOL(8),      &
     &                    WMOL(9),WMOL(10),WMOL(11)
                      TP5_LINENUMBER=TP5_LINENUMBER+1
                      READ(TP5_FILE(TP5_LINENUMBER),'((F10.0))')        &
     &                    WMOL(12)
                      TP5_LINENUMBER=TP5_LINENUMBER+1
                     ENDIF
...
!                     READ IF MDEF=2 AND IRD1=1, 8 SPECIES PER LINE:
     ...
     &                      '((8F10.0))')(WMOLX(I),I=1,8)
                          TP5_LINENUMBER=TP5_LINENUMBER+1
                          READ(TP5_FILE(TP5_LINENUMBER),                &
     &                      '((7F10.0))')(WMOLX(I),I=9,NMOLX)
                          TP5_LINENUMBER=TP5_LINENUMBER+1
                        ENDIF
