     ...
     &              NUM_LRES,SOLAR_FLUX,DIFFUSE_FLUX,LNFLRT,FLRT,       &
...
!       OUTPUT ARGUMENTS
!       SOLAR_FLUX     INCOMING SOLAR FLUX
!       NUM_LRES       LENGTH OF SOLAR_FLUX,DIFFUSE_FLUX,BB_UPDIFFUSE,ETC
!       DIFFUSE_FLUX   TOA UPWELLING DIFFUSE FLUX
!       LNFLRT         LENGTH OF FLRT (FOR DEBUGGING)
!       FLRT           FILE NAME (FOR DEBUGGING)
!       NUM_LEVS       NUMBER OF LEVELS (FOR BB_UPDIFFUSE, ETC
!       FLX_UPDIFFUSE  SPECTRAL LEVEL UPWELLING DIFFUSE FLUX
!       FLX_DNDIFFUSE  SPECTRAL LEVEL DOWNWELLING DIFFUSE FLUX
!       FLX_DNDIRECT   SPECTRAL LEVEL DOWNWELLING DIRECT FLUX
