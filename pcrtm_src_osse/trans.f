     ...
     &  GROUND,KNTRVL,NLOS,LNFILT,SUNFUN,APPREF,DH2O,MLTRFL,            &
...
!       BB_UPDIFFUSE   LEVEL BROADBAND UPWELLING DIFFUSE FLUX
!       BB_DNDIFFUSE   LEVEL BROADBAND DOWNWELLING DIFFUSE FLUX
!       BB_DNDIRECT    LEVEL BROADBAND DOWNWELLING DIRECT FLUX
...
!       FLX_DNDIRECT   SPECTRAL LEVEL DOWNWELLING DIRECT FLUX
      ...
      INTEGER ICOUNT2 !FOR ASSIGNING RADIANCE VALS
...
!         PRINT HEADER AT FIRST FREQUENCY:
          ICOUNT=IPRINT
      ENDIF
      ICOUNT2 = 0 !DRF MODIFICATION FOR RADIANCE_HRES,CALL WRTPLOT
...
!                 DISORT MULTIPLE SCATTERING AND FLUXES:
     ...
     &              FDNTRT,FDNRT,KNTRVL,GROUND,TRNLOS,BTERM,            &
     &              NUM_LRES,SOLAR_FLUX,DIFFUSE_FLUX,LNFLRT,FLRT,       &
     &              NUM_LEVS,FLX_UPDIFFUSE,FLX_DNDIFFUSE,FLX_DNDIRECT)
              ELSE
...
!         CHECK IF VALUES ARE TO BE PRINTED:
     ...
     &      (IBINRS.GT.1 .OR. OSHIFT.EQ.0.))FACTOR=.5D0
          ICOUNT=ICOUNT+NLOS
          NSPCDT=NSPCDT+1
          ICOUNT2 = ICOUNT2 + 1 !DRF MODIFICATION
...
!!!BEGIN DRF MODIFICATION
     ...
     &          TRNLOS,CONVRT,SUMT,NUM_HRES,WV_HRES,RADIANCE_HRES,      &
     &          ICOUNT2)
!!!END DRF MODIFICATION
          ENDIF
          FACTOR=1.D0
