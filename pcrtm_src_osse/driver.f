      SUBROUTINE DRIVER(ID,FILE_NAME,FLENGTH,TP5_FLAG,TP5_FILE,NUM_LEVS &
...
!       MODTRN   MODTRAN BAND MODEL FLAG.
      INTEGER MODEL,ITYPE,IEMSCT,M1,M2,M3,I_RD2C,NOPRNT,BGTP5
      LOGICAL MODTRN
...
!      open(617,file='radiance'//LABEL//'.out',status='replace')
      ...
      DO itp5 = 1, ntp5
!       READ MULTIPLE TAPE5 FILES 

      READ(ifntp5,'(A120)' ) ctape5fn
      BGTP5 = INDEX(CTAPE5FN, 'tp5')-2
      CTAPE5FN=CTAPE5FN(1:BGTP5)//LABEL//'.tp5'
...
!     WRITE HEADERS AND READ CARD 5:
      ...
      CALL CD5(FLRT,LNFLRT,H2OCOL,O3COL,TPTMPS,TP5_FLAG,TP5_FILE,       &
     &   TP5_LINENUMBER)
      IRPTSV=IRPT
      IRPT=ABS(IRPT)
