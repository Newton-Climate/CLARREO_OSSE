...
!
   ...
   real(r8) dummy    ! for longitude
   integer dummy_index    ! for longitude
...
!
   ...
   dummy_index = maxloc(coszrs,1)
   dummy = clon(dummy_index)
   do i=1,ncol
     coszrs(i) = shr_orb_cosz(calday,clat(i),dummy,delta)
   end do
