module filenames
!
! Settings for CAM+IPCC testing
! 
  character(len=256) :: absems_data      = '/fis/cgd/cseg/csm/inputdata/atm/cam2/rad/abs_ems_factors_fastvx.c030508.nc'
  character(len=256) :: aeroptics        = '/fis/cgd/cseg/csm/inputdata/atm/cam2/rad/AerosolOptics_c040105.nc'
  character(len=256) :: bndtvaer         = '/fis/cgd/cseg/csm/inputdata/atm/cam2/rad/AerosolMass_V_128x256_clim_c031022.nc'
  character(len=256) :: bndtvcarbonscale = '/fis/cgd/cseg/csm/inputdata/atm/cam2/rad/carbonscaling_1870-2000_c040225.nc'
  character(len=256) :: bndtvghg         = '/fis/cgd/cseg/csm/inputdata/atm/cam2/ggas/ghg_1870_2100_c040122.nc'
  character(len=256) :: bndtvo           = '/fis/cgd/cseg/csm/inputdata/atm/cam2/ozone/mozart.o3.128x64_L18_1870-2000_c040123.nc'
  character(len=256) :: bndtvscon        = '/fis/cgd/cseg/csm/inputdata/atm/cam2/rad/scon_lean_1870-2100_c040123.nc'
  character(len=256) :: bndtvvolc        = '/fis/cgd/cseg/csm/inputdata/atm/cam2/rad/VolcanicMass_1870-1999_64x1_L18_c040115.nc'
  character(len=256) :: ncdata           = '/cgd/cms/jmccaa/inic/eul128x256_d63iamip.cam2.i.1951-01-01-00000.nc'
  character(len=256) :: brdf_file        = '../input_files/modis_brdf.nc'  !DRF
  character(len=256) :: emis_file        = '../input_files/modis_emis.nc'  !DRF
  character(len=256) :: alb_file         = '../input_files/modis_albedo.nc'  !DRF
  character(len=256) :: alb_snow         = '../input_files/modis_snow.nc'  !DRF
  character(len=256) :: ocean_refl       = '../input_files/ocean_refl.nc'  !DRF
  character(len=256) :: snow_refl        = '../input_files/snow_refl.nc'  !DRF
  character(len=256) :: snow_brdf        = '../input_files/snow_brdf.nc'  !DRF
  character(len=256) :: snow_frac        = '../input_files/snow_frac.nc'  !DRF
  character(len=256) :: phase_funcs      = '../input_files/modtran_mie_phase_functions.nc'  !DRF

!
! Settings for plain CAM testing
!
!   character(len=256) :: bndtvaer         = '/fis/cgd/cseg/csm/inputdata/atm/cam2/rad/AerosolMass_V_32x64_clim_c031022.nc'
!   character(len=256) :: bndtvvolc        = '/fis/cgd/cseg/csm/inputdata/atm/cam2/rad/VolcanicMass_1870-1999_64x1_L18_c040115.nc'
!   character(len=256) :: bndtvcarbonscale = '/fis/cgd/cseg/csm/inputdata/atm/cam2/rad/carbonscaling_1870-1999_c040114.nc'
!   character(len=256) :: bndtvo           = '/fis/cgd/cseg/csm/inputdata/atm/cam2/ozone/pcmdio3.r8.64x1_L60_clim_c970515.nc'
!   character(len=256) :: bndtvscon        = '/fis/cgd/cseg/csm/inputdata/atm/cam2/rad/scon_1870_2100_c040122.nc'
!   character(len=256) :: bndtvghg         = '/fis/cgd/cseg/csm/inputdata/atm/cam2/ggas/ghg_1870_2100_c040122.nc'
!   character(len=256) :: ncdata           = '/fis/cgd/cseg/csm/inputdata/atm/cam2/inic/gaus/cami_0000-09-01_32x64_L26_c030918.nc'
!
#ifndef OFFLINE
!----------------------------------------------------------------------- 
!
...
!
   ...
   character(len=256), public :: brdf_file = 'brdf_file' ! full pathname for BRDF data (DRF)
   character(len=256), public :: emis_file = 'emis_file' ! full pathname for EMIS data (DRF)
   character(len=256), public :: alb_file = 'alb_file' ! full pathname for BRDF data (DRF)
   character(len=256), public :: alb_snow = 'alb_snow' ! full pathname for BRDF data (DRF)
   character(len=256), public :: ocean_refl = 'ocean_refl' ! full pathname for BRDF data (DRF)
   character(len=256), public :: snow_refl = 'snow_refl' ! full pathname for BRDF data (DRF)
   character(len=256), public :: snow_brdf = 'snow_brdf' ! full pathname for BRDF data (DRF)
   character(len=256), public :: snow_frac = 'snow_frac' ! full pathname for snow-fraction data (DRF)
   character(len=256), public :: phase_funcs = 'phase_funcs' ! full pathname for BRDF data (DRF)
