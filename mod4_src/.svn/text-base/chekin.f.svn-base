      SUBROUTINE  CHEKIN(ACCUR, ALBEDO, BTEMP, DTAUC, FBEAM, FISOT,     &
     &                    IBCND, LAMBER, MAXCLY, MAXCMU,                &
     &                    MAXPHI, MAXULV, MAXUMU, MXCLY, MXCMU, MXPHI,  &
     &                    MXULV, MXUMU, NLYR, NPHI, NSTR, NTAU, NUMU,   &
     &                    ONLYFL, PHI, PHI0, PLANK, PMOM, SSALB, TAUC,  &
     &                    TEMIS, TEMPER, TTEMP, UMU, UMU0, USRANG,      &
     &                    USRTAU, UTAU, WVNMHI, WVNMLO)
