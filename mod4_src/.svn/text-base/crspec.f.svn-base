      SUBROUTINE CRSPEC(CTHICK,CWDCOL,CIPCOL,WVL_CLD,EXT_LIQ_CLD,       &
     &            SSA_LIQ_CLD,ASYM_LIQ_CLD,EXT_ICE_CLD,                 &
     &            SSA_ICE_CLD,ASYM_ICE_CLD,NUM_LEVS,NUM_AC_WVL)

!     THIS ROUTINE DEFINES CLOUD PARTICLE SPECTRAL DATA:
...
!     MDLCLD    MAPS CLOUD/RAIN MODEL INDICES INTO CLOUD MODEL INDICES
!     MDLCIR    MAPS CLOUD/RAIN MODEL INDICES INTO CIRRUS MODEL INDICES
!     CLDX55    0.55 MICRON CLOUD MODEL EXTINCTION COEFS [KM-1 M3/GM]
!     CIRX55    0.55 MICRON CIRRUS MODEL EXTINCTION COEFS [KM-1 M3/GM]
