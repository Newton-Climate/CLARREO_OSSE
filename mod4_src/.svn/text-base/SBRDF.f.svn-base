...
C     PARAMS(1)   REAL PART OF COMPLEX REFRACTION INDEX  OF THE SURFACE
C     PARAMS(2)   IMAGINARY PART OF COMPLEX REFRACTION INDEX  OF THE SURFACE
...
C     EXTERNALS
      EXTERNAL ERF,FRESNEL_ROSS
      DOUBLE PRECISION ERF,FRESNEL_ROSS
...
C------------------------------------------------------------------
  ...
  800 RETURN
      ...
      DOUBLE PRECISION FUNCTION FRESNEL_ROSS(N,K,COSW)
