      REAL FUNCTION O2MATE(V)

!     THIS ROUTINE WAS ADOPTED FROM LBLRTM.
...
!     THE UNITS OF THESE CONTINUA COEFFICIENTS
!     ARE  1 / (AMAGAT_O2*AMAGAT_AIR)
...
!     JOURNAL OF GEOPHYSICAL RESEARCH (1997).
      ...
      INTEGER I,IVHALF
      REAL V,O2C127(3768:4250)

      DATA (O2C127(I),I=3768,3817)/                                     &
...
!     NEAREST NEIGHBOR SEARCH:
      IVHALF=INT(V/2+.501)
      IF(IVHALF.LT.3768 .OR. IVHALF.GT.4250)THEN
          O2MATE=0.
      ELSE
          O2MATE=O2C127(IVHALF)
      ENDIF
      RETURN
      END
