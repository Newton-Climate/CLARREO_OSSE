...
!           E.T. FLORANCE O.N.R. PASADENA CA.
      ...
      DIMENSION ATTAB(35,9),RATTAB(9),FACTOR(5,8,5)
      DIMENSION X(4),Y(4),ATTN(4),RATES(4)
      DIMENSION TMPTAB(5),FACIT(5),TFACT(5)
...
!     GIVE ZERO ATTN IF RATE FALLS BELOW LIMIT
      GMRAIN=0.
      IF(RATE.LE.RATLIM)RETURN
      DO 10 I=3,33
          IF(FREQ.LT.WVNTBL(I))GOTO20
   10 CONTINUE
      I=34
   20 CONTINUE
      ILOW=I-3
      DO 30 K=3,7
          IF(RATE.LT.RATTAB(K))GOTO40
   30 CONTINUE
      K=8
   40 CONTINUE
      KMIN=K-3
...
!     APPLY TEMPERATURE CORRECTION
      ILOW=1
      DO 80 ILOWP1=2,4
          IF(T.LT.TMPTAB(ILOWP1))GOTO90
          ILOW=ILOWP1
   80 CONTINUE
      ILOWP1=5
   90 CONTINUE
      DO 100 J=2,7
          IF(FREQ.LT.TFREQ(J))GOTO110
  100 CONTINUE
      J=8
  110 CONTINUE
      JLOW=J-2
