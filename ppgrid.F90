...
! Grid point resolution parameters
   ...
   integer wvlng2     ! DRF wavelengths for Modtran
   integer wvlng_hres2 ! DRF wavelengths for Modtran

   parameter (pcols  = PCOLS)
   parameter (pver   = PLEV)
   parameter (pvermx = 4)
   parameter (pverp  = pver + 1  )
   parameter (wvlng2 = WVLNGTH_LRES)
   parameter (wvlng_hres2 = WVLNGTH_HRES)
!
