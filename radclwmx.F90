...
!
   ...
   real(r8) :: qnm_local(pcols,pver)
   real(r8) :: o3_local(pcols,pver)
   integer iii
   integer jj
!
!
...
!
   ...
   do iii=1,pcols
      do jj=1,pver
         qnm_local(iii,jj) = qnm(iii,jj)
         o3_local(iii,jj) = o3vmr(iii,jj)
      end do
   end do
...
!
   call radtpl(lchnk   ,ncol    ,                            &
               tnm     ,lwupcgs ,qnm_local     ,pint    ,plco2   ,plh2o   , &
...
!
      call radoz2(lchnk, ncol, o3_local   ,pint    ,plol    ,plos, ntoplw    )
!
! Compute trace gas path lengths
!
      call trcpth(lchnk   ,ncol    ,                            &
                  tnm     ,pint    ,cfc11   ,cfc12   ,n2o     , &
                  ch4     ,qnm_local     ,ucfc11  ,ucfc12  ,un2o0   , &
