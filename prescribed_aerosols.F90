...
subroutine get_aerosol(c, pint, AEROSOLt, scale)
!------------------------------------------------------------------
!
!  Input:
...
subroutine vert_interpolate (Match_ps, pint, n, AEROSOL_mmr, ncol, c)
!--------------------------------------------------------------------
...
subroutine background(lchnk, ncol, pint, mmr)
!----------------------------------------------------------------------- 
! 
! Purpose: 
...
subroutine aerosol_indirect(ncol,lchnk,landfrac,pmid,t,qm1,cld,zm,rel)
!--------------------------------------------------------------
